...
<div align="center">
  <br>
  <h2>기술이 세상의 문제를 해결할 수 있다고 믿는 백엔드 개발자 <b>유동훈</b>입니다.</h2>
  <br>
</div>
...
<table width="100%">
  <tr>
    <td width="60%" align="center" valign="center">
      <blockquote>
        <b>누군가에겐 너무나도 사소해서 지나쳐버렸을 <br>작지만 중요한 문제들을 조명하고 싶습니다.</b>
      </blockquote>
      <br>
      <blockquote>
        한 배우가 시각장애인을 위해 기획 단계부터 오디오북을 염두해둔 소설을 출간한 일화에 깊은 감명을 받았습니다.<br>
        저 역시 기술을 통해 <b>작은 것들을 따뜻하게 바라보고, 제 이름을 걸고 세상을 이롭게 변화시키는 개발자</b>가 되고자 합니다.
      </blockquote>
      <br><br>
      <p>
        하지만 좋은 의도도 <b>확실한 실력</b>이 있어야만 현실로 만들 수 있다고 믿습니다.<br>
        저의 가장 큰 무기는 <b>어떤 환경에서도 기어코 성과를 만들어내는 집요함</b>입니다. <br>이를 바탕으로, 마주한 문제의 해결책을 만들어내겠습니다.
      </p>
    </td>
    <td width="40%" valign="center">
      <br> <h4 style="margin-top: 0;">이력</h4>
      <ul>
        <li> 대학교 우수 졸업생 (GPA 4.37)</li>
        <li> 삼성청년SW·AI아카데미 14기 수료</li>
      </ul>
      <h4>수상</h4>
      <ul>
        <li> [2025.12] 코레일 네일로 해커톤 2025 우수상</li>
        <li> [2025.12] 새싹 해커톤 2025 본선 진출</li>
        <li> [2024.06] 교내 캡스톤 경진대회 수상</li>
      </ul>
      <h4>자격</h4>
      <ul>
        <li> [2025.12] 정보처리기사 / SQLD</li>
        <li> [2024.05] TOPCIT 3수준 (433점)</li>
        <li> [2019.04] 네트워크관리사 2급</li>
      </ul>
      <br> </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" align="center">
      <img src="https://github-readme-stats.vercel.app/api?username=dbehdgns1215&show_icons=true&theme=graywhite&hide_border=true"/>
    </td>
    <td width="50%" align="center">
      <img src="https://streak-stats.demolab.com?user=dbehdgns1215&theme=graywhite&hide_border=true"/>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="http://mazassumnida.wtf/api/v2/generate_badge?boj=dbehdgns1215"/>
    </td>
    <td width="50%" align="center">
      <img src="http://mazandi.herokuapp.com/api?handle=dbehdgns1215&theme=cold"/>
    </td>
  </tr>
</table>
